...
if(pdo_tableexists('longbing_card_collection')) {
 if(!pdo_fieldexists('longbing_card_collection',  'create_time')) {
  pdo_query("ALTER TABLE ".tablename('longbing_card_collection')." ADD `create_time` int(10) NOT NULL;");
 }
}
if(pdo_tableexists('longbing_card_collection')) {
 if(!pdo_fieldexists('longbing_card_collection',  'update_time')) {
  pdo_query("ALTER TABLE ".tablename('longbing_card_collection')." ADD `update_time` int(10) NOT NULL;");
 }
}
if(pdo_tableexists('longbing_card_collection')) {
...
if(pdo_tableexists('longbing_card_timeline')) {
 if(!pdo_fieldexists('longbing_card_timeline',  'content')) {
  pdo_query("ALTER TABLE ".tablename('longbing_card_timeline')." ADD `content` text();");
 }
}
if(pdo_tableexists('longbing_card_timeline')) {
